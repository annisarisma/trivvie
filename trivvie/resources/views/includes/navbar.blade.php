        ...
        <div class="collapse navbar-collapse" id="navb">
            ...
            @guest
                ...
                <form class="form-inline my-2 my-lg-0 d-none d-md-block">
                    <button class="btn btn-login btn-navbar-right my-2 my-sm-0 px-4" style=" border-radius: 10px;" type="button"
                onclick="event.preventDefault(); location.href='{{ url('login')}}';">
                    Masuk
                    </button>
                </form>
            ...
            @auth
                ...
                method="POST">
                    @csrf
                    <button class="btn btn-login btn-navbar-right my-2 my-sm-0 px-4" style=" border-radius: 10px;" type="submit">
                    keluar
                    </button>
                </form>
            @endauth
